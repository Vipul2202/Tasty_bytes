        ...
        <div className="container text-center pt-5 pb-3">
          ...
          <nav aria-label="breadcrumb animated slideInDown">
            <ol className="breadcrumb justify-content-center mb-0">
              <p className="text-white font-extrabold font-serif text-2xl">
                Indulge in the finest, freshly baked delights at Shree Krishna
                Bakers, where every bite is a celebration of taste and quality!
              </p>
            </ol>
          </nav>
        </div>
            ...
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
              <div className="h-100">
                <h1 className="display-6 mb-4">
                  Wbbbbe Bake Every Item From The Core Of Our Hearts
                </h1>
                <p>
